...
export function CloudProviderIcon({ provider, className = 'h-4 w-4' }: CloudProviderIconProps) {
  switch (provider) {
    case 'google_drive':
      return (
    ...
    case 'dropbox':
      return (
        <svg className={className} viewBox="0 0 43 40" xmlns="http://www.w3.org/2000/svg">
