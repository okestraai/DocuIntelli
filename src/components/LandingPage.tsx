...
export function LandingPage({ onGetStarted, onSignIn, onViewPricing, onViewFeatures }: LandingPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50/30">
      {/* Top Navigation */}
      <nav className="relative bg-white/80 backdrop-blur-sm border-b border-slate-200 sticky top-0 z-50">
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4">
              ...
              <button
                ...
                className="flex items-center gap-3 bg-white border border-slate-300 hover:bg-slate-50 disabled:opacity-60 text-slate-700 font-medium py-3 sm:py-4 px-6 sm:px-8 rounded-xl text-base sm:text-lg transition-all shadow-sm hover:shadow"
              >
                {isGoogleLoading ? (
      ...
      {/* Features Section */}
      <div id="features" className="py-12 sm:py-20 bg-white scroll-mt-16">
