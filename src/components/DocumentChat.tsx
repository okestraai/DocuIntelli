...
import { chatWithDocument, loadChatHistory, logClientError, warmupChatFunction } from '../lib/api';
...
export function DocumentChat({ document, onBack, onUpgradeNeeded }: DocumentChatProps) {
  ...
  // Pre-warm edge function on mount to eliminate cold start
  useEffect(() => { warmupChatFunction(); }, []);
