        ...
        <div className="flex items-center justify-between h-16 sm:h-20">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2">
            ...
            <button
              ...
              className="group relative flex items-center justify-center p-3 text-slate-600 hover:text-emerald-700 hover:bg-slate-100 rounded-xl transition-all duration-200"
            >
            ...
            <button
              onClick={onSignOut}
              className="group relative flex items-center justify-center p-3 text-slate-600 hover:text-red-600 hover:bg-red-50 rounded-xl transition-all duration-200"
            >
