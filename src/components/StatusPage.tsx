...
export function StatusPage({ onBack }: StatusPageProps) {
  const [services, setServices] = useState<ServiceStatus[]>([
    ...
    { name: 'Document Storage', description: 'Azure Blob Storage for uploaded documents', status: 'operational' },
    ...
    { name: 'Authentication', description: 'Custom JWT authentication for sign-in and session management', status: 'operational' },
